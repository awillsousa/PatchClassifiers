...
def show_patch(arq_img):
    from ptxwiser.Imagem import Imagem
    from ptxwiser.Patch import Patch
    from ptxwiser.BaseAtributos import BaseAtributos
    from ptxwiser.DictBasePatches import DictBasePatches
