...
def main():
    FOLDS_MODEL = [(1,'/home/willian/bases/cancer/fold1/test/400X/','fold1/pesos-fase02.h5'),
                   (2,'/home/willian/bases/cancer/fold2/test/400X/','fold2/pesos-fase02.h5'),
                   (3,'/home/willian/bases/cancer/fold3/test/400X/','fold3/pesos-fase02.h5'),
                   (4,'/home/willian/bases/cancer/fold4/test/400X/','fold4/pesos-fase02.h5'),
                   (5,'/home/willian/bases/cancer/fold5/test/400X/','fold5/pesos-fase02.h5')]
    ...
    for num_fold,image_dir,pesos_fase02 in FOLDS_MODEL:
        #Cria o modelo a ser treinado  
        arquivo_pesos = os.path.join('./models/'+pesos_fase02)
        ...
        for id_img,arq_img in enumerate(arqs_imgs):
            ...
            patches = gera_patches(imagem, arq_img, rotulo, tamanho=PTX_SIZE, desloca=DESLOCA)
        ...
        # Computa metricas, curva ROC e AUC
    ...
    plt.savefig('plots/todos-folds-400X.png')
    #plt.show()
