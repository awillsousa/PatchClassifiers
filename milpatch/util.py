...
def marca_patches(arq_img, patches, legenda="X", tam_patch=64, rgb=True, saida="plots/ptxsmarcados.png"):        
    ...
    for p in patches:
        cor_borda = 'red'        
        ax.add_patch(Rectangle(p['posicao'], *p['tamanho'],fill=False,lw=2, edgecolor=cor_borda))        
